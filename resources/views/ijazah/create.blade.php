...
@section('title', 'Generate Ijazah Baru - Website Generate dan Cetak Ijazah Simulasi')

@section('content')
<div class="max-w-4xl mx-auto space-y-6">
    <div class="pb-5 border-b border-gray-200">
        <h1 class="text-2xl font-bold font-outfit text-gray-900 sm:text-3xl">Generate Ijazah Simulasi</h1>
        <p class="mt-1.5 text-sm text-gray-500">Masukkan data ijazah secara lengkap untuk membuat dokumen simulasi penelitian.</p>
    </div>
    ...
    <form action="{{ route('ijazah.store') }}" method="POST" class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nomor_seri" id="nomor_seri" value="{{ old('nomor_seri') }}" required maxlength="150" placeholder="Contoh: MHS-SIM-2026-0001"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_universitas" id="nama_universitas" value="{{ old('nama_universitas') }}" required maxlength="150" placeholder="Contoh: Universitas Indonesia"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_mahasiswa" id="nama_mahasiswa" value="{{ old('nama_mahasiswa') }}" required maxlength="150" placeholder="Nama Lengkap"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="npm" id="npm" value="{{ old('npm') }}" required maxlength="50" placeholder="Nomor Pokok Mahasiswa"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="program_studi" id="program_studi" value="{{ old('program_studi') }}" required maxlength="150" placeholder="Contoh: Teknik Informatika"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="fakultas" id="fakultas" value="{{ old('fakultas') }}" required maxlength="150" placeholder="Contoh: Fakultas Ilmu Komputer"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="gelar" id="gelar" value="{{ old('gelar') }}" required maxlength="150" placeholder="Contoh: Sarjana Komputer (S.Kom.)"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lulus" id="tanggal_lulus" value="{{ old('tanggal_lulus') }}" required
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="tempat_terbit" id="tempat_terbit" value="{{ old('tempat_terbit') }}" required maxlength="150" placeholder="Contoh: Depok"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama_dekan" id="nama_dekan" value="{{ old('nama_dekan') }}" required maxlength="150" placeholder="Nama Dekan beserta gelar"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nip_dekan" id="nip_dekan" value="{{ old('nip_dekan') }}" required maxlength="50" placeholder="Nomor Induk Pegawai Dekan"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_rektor" id="nama_rektor" value="{{ old('nama_rektor') }}" required maxlength="150" placeholder="Nama Rektor beserta gelar"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nip_rektor" id="nip_rektor" value="{{ old('nip_rektor') }}" required maxlength="50" placeholder="Nomor Induk Pegawai Rektor"
                            class="w-full bg-gray-50 border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:bg-white focus:border-gray-900 transition-colors">
                    </div>
                </div>
            </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end space-x-3">
            <a href="{{ route('ijazah.index') }}" class="px-4 py-2 border border-gray-300 rounded text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                Batal
            </a>
